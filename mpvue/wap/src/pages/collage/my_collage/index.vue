  ...
  <div class="my_collage">
    ...
    <div class="goods"  v-for="(goodslist ,index) in goodslists" :key="index">
      ...
      <div class="active_good_detail">
        ...
        <!--按钮-->
        <router-link class="active-btn" :to="'/collage/group_detail/' + goodslist.group.id">查看详情</router-link>
        <!--<a class="active-btn" :href="'../group_detail/main?id=' + goodslist.group.id">查看详情</a>-->
      </div>
    </div>
  ...
  export default {
    data () {
      return {
        ...
        str:'',
        goodslists: [],
        active: {name: '拼团', img: '~images/collagebanner.jpg', url: '../collage_detail/main'}
      }
    },
    components: {
      activeBanner,
  ...
  .my_collage{width:100%;padding-bottom:50px;
    .goods{margin: .4rem;box-shadow:0 5px 18px #ddd;background: #fff;border-radius: 10px;position: relative;
      ...
      .active_img{height:200px;
        .good_img{width:90%;height:100%;margin:0 5%;}
      }
