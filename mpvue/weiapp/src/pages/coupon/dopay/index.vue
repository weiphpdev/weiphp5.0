<template>
  <div class="coupon-show">
    ...
    <div class="u-button__bar">
      ...
      <a href="../../shop/center/index" v-else class="u-button u-button--square">返回个人中心</a>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    dopay () {
      get(`coupon/api/do_pay_ok/sn_id/${this.id}/PHPSESSID/${wx.getStorageSync('PHPSESSID')}`).then(res => {
  ...
  onLoad () {
    ...
    get(`coupon/api/do_pay/sn_id/${this.id}/PHPSESSID/${wx.getStorageSync('PHPSESSID')}`).then(res => {
