DELETE FROM `wp_model` WHERE `name`='stores' ORDER BY id DESC LIMIT 1;
DROP TABLE IF EXISTS `wp_stores`;


DELETE FROM `wp_model` WHERE `name`='shop_user_level_link' ORDER BY id DESC LIMIT 1;
DROP TABLE IF EXISTS `wp_shop_user_level_link`;


DELETE FROM `wp_model` WHERE `name`='stores_link' ORDER BY id DESC LIMIT 1;
...
DELETE FROM `wp_model` WHERE `name`='goods_category_link' ORDER BY id DESC LIMIT 1;
DROP TABLE IF EXISTS `wp_goods_category_link`;


DELETE FROM `wp_model` WHERE `name`='goods_param_link' ORDER BY id DESC LIMIT 1;
DROP TABLE IF EXISTS `wp_goods_param_link`;


DELETE FROM `wp_model` WHERE `name`='goods_store_link' ORDER BY id DESC LIMIT 1;
DROP TABLE IF EXISTS `wp_goods_store_link`;


DELETE FROM `wp_model` WHERE `name`='shop_goods_comment' ORDER BY id DESC LIMIT 1;
...
DELETE FROM `wp_model` WHERE `name`='shop_track' ORDER BY id DESC LIMIT 1;
DROP TABLE IF EXISTS `wp_shop_track`;


DELETE FROM `wp_model` WHERE `name`='goods_param_temp' ORDER BY id DESC LIMIT 1;
...
DELETE FROM `wp_model` WHERE `name`='shop_order_goods' ORDER BY id DESC LIMIT 1;
